    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
           Passionate frontend developer combining creativity, precision, and cutting-edge technologies to create immersive digital experiences. Creating user-centric web solutions
          </p>
      ...
      <div className="absolute bottom-0 right-0 z-[10]">
        <Image
          ...
          height={450}
          width={400}
          className="absolute right-35  top-40 rounded-lg"
