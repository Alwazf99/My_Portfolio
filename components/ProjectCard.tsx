...
const ProjectCard = ({ image, title, text, deployedLink }: Props) => {
  ...
  function handleFlip() {
    if (!isAnimating) {
      ...
      // Delay the navigation by 5 seconds (5000 milliseconds)
      setTimeout(() => {
        window.location.href = deployedLink; // Navigate to the deployedLink after 5 seconds
      }, 7000);
    }
  }
